        ...
        for f in os.listdir(root):
            ...
            for comp_id in begin_positions:
                ...
                for ref in ref.split('_'):
                    ...
                    dist_relative_to_prev_comment_beginning.append(begin_positions[ref]-prev_comment_begin_position[comp_id])
    
    print("Title relations: ", title_relations)
    print("Continue Relations: ", cont_relations)
    print("Relative Distances: ", distances)
    print("Distances w.r.t. beginning of previous comment of the current component's commment: ", dist_relative_to_prev_comment_beginning)
